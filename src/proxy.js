...
export async function proxy(request) {
  ...
  if (isMarkdownRequest) {
    ...
    if (cleanPath === '/' || cleanPath === '') {
      markdownContent = `# SD Negeri Bobong\n\nSelamat Datang di Website Resmi SD Negeri Bobong. "Berakhlak Mulia, Cerdas, dan Berbudaya." Kami berkomitmen menyelenggarakan pendidikan dasar yang inklusif, adaptif, dan berlandaskan kearifan lokal di Kabupaten Pulau Taliabu.\n\n## Statistik Sekolah\n- **Siswa Aktif:** 308 Siswa\n- **Guru & Staf:** 23 Guru & Staf\n- **Ruang Kelas:** 8 Kelas\n- **Akreditasi:** B\n\n## Sambutan Kepala Sekolah\n> "Pendidikan utama adalah menanamkan akhlak mulia dan ketakwaan, diiringi pengembangan kecerdasan berpikir serta pelestarian nilai budaya agar generasi siap bersaing di era global."\n\nAssalamu'alaikum Warahmatullahi Wabarakatuh,\nSalam sejahtera untuk kita semua. Selamat datang di website resmi SD Negeri Bobong. Sebagai sekolah dasar rujukan di ibukota Kabupaten Pulau Taliabu, kami berkomitmen mewujudkan layanan pendidikan yang berkualitas dengan mengutamakan pembentukan karakter siswa yang berakhlak mulia, cerdas dalam berpikir, serta luhur dalam menjaga nilai budaya bangsa. Kehadiran website ini diharapkan mampu mempererat kolaborasi antara sekolah, orang tua, dan masyarakat luas demi kemajuan belajar anak.\nWassalamu'alaikum Warahmatullahi Wabarakatuh.\n\n## Menu Utama & Rute Publik\n- [Profil Sekolah](https://sdnegeribobong.sch.id/profil) - Visi, Misi, Sejarah, dan Struktur Organisasi.\n- [Akademik](https://sdnegeribobong.sch.id/akademik) - Kurikulum, Jadwal Belajar, dan Tata Tertib Sekolah.\n- [Kesiswaan](https://sdnegeribobong.sch.id/kesiswaan) - Ekstrakurikuler, Organisasi Siswa, dan Prestasi.\n- [PPDB Online](https://sdnegeribobong.sch.id/ppdb) - Informasi Pendaftaran Peserta Didik Baru.\n- [Berita & Kegiatan](https://sdnegeribobong.sch.id/berita) - Kabar terkini dan kegiatan terbaru sekolah.\n\n## Kontak Sekolah\n- **Alamat:** Bobong, Kecamatan Taliabu Barat, Kabupaten Pulau Taliabu, Maluku Utara.\n- **Hubungi Operator WA:** Surahmi Wambes, S.Pd [https://wa.me/6282299578986](https://wa.me/6282299578986)`;
    } else if (cleanPath === '/profil') {
      markdownContent = `# Profil - SD Negeri Bobong\n\n## Visi Sekolah\nTerwujudnya peserta didik yang Berakhlak Mulia, Cerdas dalam berpikir, serta Luhur dalam Menjaga Nilai Budaya Bangsa di era global.\n\n## Misi Sekolah\n1. Menanamkan nilai keimanan, ketakwaan, dan akhlak mulia dalam setiap aktivitas harian di lingkungan sekolah.\n2. Melaksanakan pembelajaran aktif, kreatif, efektif, dan menyenangkan untuk mengoptimalkan kecerdasan serta potensi siswa.\n3. Mengintegrasikan muatan lokal kebudayaan Maluku Utara dalam pembelajaran seni dan keterampilan daerah.\n4. Membina kemandirian dan rasa peduli lingkungan hidup melalui program Sabtu Bersih dan penghijauan sekolah.\n5. Menjalin hubungan kemitraan yang harmonis dengan orang tua siswa dan masyarakat sekitar demi kesuksesan belajar anak.\n\n## Sejarah Singkat\nSD Negeri Bobong didirikan sebagai salah satu sekolah dasar perintis di Taliabu Barat untuk memberikan layanan pendidikan dasar berkualitas bagi anak-anak di Pulau Taliabu. Seiring perkembangan daerah, sekolah terus berkembang menjadi salah satu sekolah dasar rujukan di ibukota kabupaten.`;
