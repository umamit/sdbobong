...
- **Pendaftaran Online:** Klik menu **"PPDB"** di navigasi atas dan pilih **Formulir Online**, atau kunjungi halaman \`/ppdb/daftar\`.
- **Pendaftaran Offline:** Datang langsung ke sekolah pada hari kerja (Senin-Sabtu pukul 08.00-12.00 WIT). Formulir offline juga dapat diunduh di halaman Unduh Berkas.
...
- Sekolah kami terletak di pusat ibukota Kabupaten Pulau Taliabu, Maluku Utara. Anda juga dapat melihat peta lokasinya di bagian bawah halaman utama website ini.`;
  }
...
**Shift Siang (Kelas IV, V, & VI):**
- Senin - Kamis: Masuk siang pukul 12.45 WIT, pulang pukul 16.15 WIT.
- Jumat & Sabtu: **TIDAK ADA Shift Siang.** Semua siswa masuk pagi bersama. Jumat pulang pukul 11.00 WIT, Sabtu pulang pukul 12.45 WIT.

Ada yang ingin Anda tanyakan lagi mengenai jadwal KBM?`;
  }
...
8. **Fasilitas & Ruang Kelas** (ketik: *fasilitas*, *kelas*)
