...
export function AdminDashboardProvider({
  ...
  const systemStuff = useSystemHandlers({
    ...
    records: ppdbStuff.records,
    setRecords: ppdbStuff.setRecords,
    students: studentStuff.students,
    setStudents: studentStuff.setStudents,
    graduation: graduationStuff.graduation,
