  ...
  return (
    <html lang="id">
      <head>
        ...
        <title>Kesalahan Fatal Sistem - SD Negeri Bobong</title>
      ...
      <body>
        ...
        <div className="error-card">
          ...
          <h1>Kesalahan Fatal Sistem</h1>
          <p className="description">
            Terjadi gangguan kritis saat memproses permintaan Anda. Hal ini bisa disebabkan oleh ketidakstabilan koneksi internet atau server database. Silakan klik tombol di bawah untuk memuat ulang aplikasi.
          </p>
          ...
          {error && (
            <details className="details-accordion">
              <summary className="details-summary">Detail Log Kesalahan</summary>
