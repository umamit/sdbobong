        ...
        <div className="container">
          <div className="grid-2" style={{ alignItems: 'center' }}>
            <div className="reveal-on-scroll reveal-delay-200" style={{ order: 2, borderRadius: 'var(--radius-lg)', overflow: 'hidden', boxShadow: 'var(--shadow-lg)', border: '4px solid white' }}>
              <img src={akademik.kurikulum_image} alt="Aktivitas Kurikulum Merdeka" width={600} height={300} style={{ width: '100%', height: '300px', objectFit: 'cover' }} fetchPriority="high" decoding="async" />
            </div>
