...
export default function NewsCard({ news, className = '', priority = false }) {
  ...
  return (
    ...
    >
      ...
      {/* Card Content Body */}
      <div className="card-body" style={{ flex: 1, padding: '1.15rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: '0.75rem' }}>
        <div>
          <div className="card-meta" style={{ fontSize: '0.78rem', marginBottom: '6px' }}>
