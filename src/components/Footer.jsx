      ...
      <div className={`container ${styles.footerGrid}`}>
        ...
        <div className={styles.footerWidget}>
          ...
          <ul className={styles.footerLinks}>
            ...
            <li><a href="https://ajar.sdnegeribobong.sch.id" target="_blank" rel="noreferrer">Perangkat Ajar (Modul RPP) ↗</a></li>
      ...
      <div className={styles.footerBottom}>
        <div className={`container ${styles.footerBottomFlex}`}>
          ...
          <p className={styles.copyrightNote}>
            &copy; 2026 SD Negeri Bobong. Hak Cipta Dilindungi Undang-Undang. | <Link href="/login" style={{ color: '#9CA3AF', textDecoration: 'none', fontSize: '0.85rem' }}>Login</Link> <span style={{ color: '#6B7280', margin: '0 0.5rem' }}>•</span> <span style={{ color: '#9CA3AF', fontSize: '0.85rem' }}>v2.96.0</span>
          </p>
