      ...
      <section className="section-padding">
        <div className="container">
          ...
          <div className="grid-2">
            ...
            >
              <div style={{ color: 'var(--primary)', marginBottom: 'var(--space-xs)' }}>
        ...
        <div className="container" style={{ maxWidth: '700px' }}>
          <div style={{ backgroundColor: '#ffffff', padding: 'var(--space-md)', borderRadius: 'var(--radius-lg)', border: '2px dashed var(--accent)', boxShadow: 'var(--shadow-sm)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-xs)', justifyContent: 'center', alignItems: 'center' }}>
              <Link href="/ppdb/daftar" className="btn btn-secondary btn-block" style={{ maxWidth: '400px', fontSize: '1.05rem', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                Isi Formulir PPDB Online
              </Link>
              <Link href="/ppdb/cetak" target="_blank" className="btn btn-outline btn-block" style={{ maxWidth: '400px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
              ...
              {!(hasHumas || hasOperator) && (
                <p style={{ color: '#EF4444', fontWeight: 600, fontSize: '0.85rem', marginTop: '0.5rem', marginBottom: 0, display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                  Kontak WhatsApp Panitia belum diatur oleh Admin.
                </p>
              )}
            </div>
