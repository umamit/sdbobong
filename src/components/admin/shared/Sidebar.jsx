  ...
  return (
    <aside className={`sidebar ${collapsed ? 'is-collapsed' : ''}`}>
      ...
      <ul className="sidebar-menu">
        {/* Category 1: UTAMA */}
        <li className="sidebar-category-header">Utama</li>
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'overview' ? 'active' : ''}`} onClick={() => handleLinkClick('overview')}>
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'ppdb' ? 'active' : ''}`} onClick={() => handleLinkClick('ppdb')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'students' ? 'active' : ''}`} onClick={() => handleLinkClick('students')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        {/* Category 2: KONTEN */}
        <li className="sidebar-category-header">Konten</li>
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'news' ? 'active' : ''}`} onClick={() => handleLinkClick('news')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'achievements' ? 'active' : ''}`} onClick={() => handleLinkClick('achievements')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'gallery' ? 'active' : ''}`} onClick={() => handleLinkClick('gallery')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'agenda' ? 'active' : ''}`} onClick={() => handleLinkClick('agenda')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        {/* Category 3: HALAMAN & DOKUMEN */}
        <li className="sidebar-category-header">Halaman & Dokumen</li>
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'pages' ? 'active' : ''}`} onClick={() => handleLinkClick('pages')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'graduation' ? 'active' : ''}`} onClick={() => handleLinkClick('graduation')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'alumni' ? 'active' : ''}`} onClick={() => handleLinkClick('alumni')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-5.25 6.557c0 1.035.84 1.875 1.875 1.875h7.5A1.875 1.875 0 0 0 18 15" />
            </svg>
            <span>Data Alumni</span>
          </a>
        </li>
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'downloads' ? 'active' : ''}`} onClick={() => handleLinkClick('downloads')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'faqs' ? 'active' : ''}`} onClick={() => handleLinkClick('faqs')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'messages' ? 'active' : ''}`} onClick={() => handleLinkClick('messages')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        {/* Category 4: SISTEM */}
        <li className="sidebar-category-header">Sistem</li>
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'content' ? 'active' : ''}`} onClick={() => handleLinkClick('content')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
        ...
        <li className="sidebar-item">
          <a className={`sidebar-link ${activeTab === 'security' ? 'active' : ''}`} onClick={() => handleLinkClick('security')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
