  ...
  return (
    <section id="tab-security" className={`tab-pane ${activeTab === 'security' ? 'active' : ''}`}>
             ...
             <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'var(--space-md)', marginBottom: 'var(--space-lg)' }}>
               ...
               <div className="card shadow-md" style={{ background: '#ffffff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem', position: 'relative', overflow: 'hidden' }}>
                 <div style={{
                   width: '52px',
                   height: '52px',
                   borderRadius: '12px',
                   ...
                   background: activeThreats.length > 0 ? '#fee2e2' : '#dcfce7',
                   color: activeThreats.length > 0 ? '#dc2626' : '#15803d'
                 }}>
                 ...
                 <div>
                   <h4 style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 600 }}>Status Keamanan</h4>
                   <p style={{ margin: '0.2rem 0 0 0', fontSize: '1.25rem', fontWeight: 800, color: 'var(--text-main)' }}>
               ...
               <div className="card shadow-md" style={{ background: '#ffffff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem', position: 'relative', overflow: 'hidden' }}>
                 ...
                 <div>
                   <h4 style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 600 }}>Jejak Audit Tercatat</h4>
                   <p style={{ margin: '0.2rem 0 0 0', fontSize: '1.25rem', fontWeight: 800, color: 'var(--text-main)' }}>
               ...
               <div className="card shadow-md" style={{ background: '#ffffff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem', position: 'relative', overflow: 'hidden' }}>
                 <div style={{
                   ...
                   alignItems: 'center',
                   justifyContent: 'center',
                   background: (config?.suspicious_attempts || []).filter(a => a.attempts >= 5 && a.resolved !== true).length > 0 ? '#fee2e2' : '#f1f5f9',
                   color: (config?.suspicious_attempts || []).filter(a => a.attempts >= 5 && a.resolved !== true).length > 0 ? '#dc2626' : '#64748b'
                 }}>
                 ...
                 <div>
                   <h4 style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 600 }}>IP Terblokir Sementara</h4>
                   <p style={{ margin: '0.2rem 0 0 0', fontSize: '1.25rem', fontWeight: 800, color: 'var(--text-main)' }}>
             ...
             <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: 'var(--space-md)', marginBottom: 'var(--space-lg)' }}>
               ...
               <div className="card shadow-lg" style={{ background: '#ffffff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '1.5rem' }}>
                 <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.25rem' }}>
                   <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>
                   <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: 'var(--text-main)' }}>Kebijakan Parameter Keamanan</h3>
                 </div>
                 ...
                 <form onSubmit={handleSaveSecuritySettings} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                   <div>
                     ...
                     <select
                       ...
                       style={{ background: '#f8fafc', border: '1px solid var(--border-color)', padding: '0.55rem 1rem', fontSize: '0.85rem', width: '100%', borderRadius: '8px', color: 'var(--text-main)', fontWeight: 600 }}
                     >
               ...
               <div className="card shadow-lg" style={{ background: '#ffffff', border: '1px solid var(--border-color)', borderRadius: '16px', padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                 <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                   ...
                   <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: 'var(--text-main)' }}>Daftar Hitam IP Manual</h3>
                 </div>
                   ...
                   <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                     <div style={{ flex: 1, minWidth: '160px' }}>
                       <input
                         ...
                         className="form-control"
                         style={{ background: '#f8fafc', border: '1px solid var(--border-color)', padding: '0.55rem 1rem', fontSize: '0.85rem', width: '100%', borderRadius: '8px', color: 'var(--text-main)' }}
                         required
                       />
                     </div>
                 ...
                 <div style={{ flex: 1, overflowY: 'auto', maxHeight: '180px', border: '1px solid var(--border-color)', borderRadius: '8px', background: '#f8fafc', padding: '0.5rem' }}>
                   {config?.manual_blacklist && config?.manual_blacklist?.length > 0 ? (
                     <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                       {config?.manual_blacklist?.map((item, index) => (
                         <div key={index} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#ffffff', padding: '0.5rem 0.75rem', borderRadius: '6px', border: '1px solid var(--border-color)' }}>
                           <div style={{ display: 'flex', flexDirection: 'column', gap: '0.1rem' }}>
                             <span style={{ fontSize: '0.85rem', fontWeight: 700, color: '#ef4444' }}>{item.ip}</span>
