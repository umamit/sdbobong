...
export default function ChatToggle({ isOpen, toggleChat, showBadge, showGreeting, greetingText, onGreetingClick }) {
  return (
    <div className={styles.aimAiTriggerWrapper}>
      {showGreeting && (
        <div className={styles.greetingBubble} onClick={onGreetingClick} role="button" aria-label="Buka chat Aim AI">
          {greetingText}
          <span className={styles.greetingTail} />
        </div>
      )}
      <button 
