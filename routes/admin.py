...
@admin_bp.route('/admin/ppdb/status/<record_id>', methods=['POST'])
@login_required
...
@admin_bp.route('/admin/ppdb/delete/<record_id>', methods=['POST'])
@login_required
...
@admin_bp.route('/admin/ppdb/export')
@login_required
...
@admin_bp.route('/admin/news/add', methods=['POST'])
@login_required
def admin_news_add():
...
@admin_bp.route('/admin/teachers/add', methods=['POST'])
@login_required
...
@admin_bp.route('/admin/teachers/edit/<teacher_id>', methods=['GET', 'POST'])
@login_required
...
@admin_bp.route('/admin/teachers/delete/<teacher_id>', methods=['POST'])
@login_required
